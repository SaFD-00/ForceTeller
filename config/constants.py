...
BRANCHES: Dict[int, Dict] = {
    0:  {"korean": "자", "chinese": "子", "element": Element.WATER, "polarity": Polarity.YANG,
         "animal": "쥐", "animal_en": "Rat", "month_angle": 270, "time_range": (23, 1)},
    1:  {"korean": "축", "chinese": "丑", "element": Element.EARTH, "polarity": Polarity.YIN,
         "animal": "소", "animal_en": "Ox", "month_angle": 300, "time_range": (1, 3)},
    2:  {"korean": "인", "chinese": "寅", "element": Element.WOOD, "polarity": Polarity.YANG,
         "animal": "호랑이", "animal_en": "Tiger", "month_angle": 315, "time_range": (3, 5)},
    3:  {"korean": "묘", "chinese": "卯", "element": Element.WOOD, "polarity": Polarity.YIN,
         "animal": "토끼", "animal_en": "Rabbit", "month_angle": 345, "time_range": (5, 7)},
    4:  {"korean": "진", "chinese": "辰", "element": Element.EARTH, "polarity": Polarity.YANG,
         "animal": "용", "animal_en": "Dragon", "month_angle": 15, "time_range": (7, 9)},
    5:  {"korean": "사", "chinese": "巳", "element": Element.FIRE, "polarity": Polarity.YIN,
         "animal": "뱀", "animal_en": "Snake", "month_angle": 45, "time_range": (9, 11)},
    6:  {"korean": "오", "chinese": "午", "element": Element.FIRE, "polarity": Polarity.YANG,
         "animal": "말", "animal_en": "Horse", "month_angle": 75, "time_range": (11, 13)},
    7:  {"korean": "미", "chinese": "未", "element": Element.EARTH, "polarity": Polarity.YIN,
         "animal": "양", "animal_en": "Sheep", "month_angle": 105, "time_range": (13, 15)},
    8:  {"korean": "신", "chinese": "申", "element": Element.METAL, "polarity": Polarity.YANG,
         "animal": "원숭이", "animal_en": "Monkey", "month_angle": 135, "time_range": (15, 17)},
    9:  {"korean": "유", "chinese": "酉", "element": Element.METAL, "polarity": Polarity.YIN,
         "animal": "닭", "animal_en": "Rooster", "month_angle": 165, "time_range": (17, 19)},
    10: {"korean": "술", "chinese": "戌", "element": Element.EARTH, "polarity": Polarity.YANG,
         "animal": "개", "animal_en": "Dog", "month_angle": 195, "time_range": (19, 21)},
    11: {"korean": "해", "chinese": "亥", "element": Element.WATER, "polarity": Polarity.YIN,
         "animal": "돼지", "animal_en": "Pig", "month_angle": 225, "time_range": (21, 23)},
}
...
HIDDEN_STEMS_DETAILED: Dict[int, List[Dict[str, Any]]] = {
    ...
    1:  [{"stem": 9, "ratio": 30}, {"stem": 7, "ratio": 30}, {"stem": 5, "ratio": 40}],  # 축: 계, 신, 기
    2:  [{"stem": 4, "ratio": 20}, {"stem": 2, "ratio": 30}, {"stem": 0, "ratio": 50}],  # 인: 무, 병, 갑
    3:  [{"stem": 1, "ratio": 100}],  # 묘: 을
    4:  [{"stem": 1, "ratio": 30}, {"stem": 9, "ratio": 30}, {"stem": 4, "ratio": 40}],  # 진: 을, 계, 무
    5:  [{"stem": 4, "ratio": 20}, {"stem": 6, "ratio": 30}, {"stem": 2, "ratio": 50}],  # 사: 무, 경, 병
    6:  [{"stem": 3, "ratio": 30}, {"stem": 5, "ratio": 70}],  # 오: 정, 기
    7:  [{"stem": 3, "ratio": 30}, {"stem": 1, "ratio": 30}, {"stem": 5, "ratio": 40}],  # 미: 정, 을, 기
    8:  [{"stem": 4, "ratio": 20}, {"stem": 8, "ratio": 30}, {"stem": 6, "ratio": 50}],  # 신: 무, 임, 경
    9:  [{"stem": 7, "ratio": 100}],  # 유: 신
    10: [{"stem": 7, "ratio": 30}, {"stem": 3, "ratio": 30}, {"stem": 4, "ratio": 40}],  # 술: 신, 정, 무
    11: [{"stem": 4, "ratio": 20}, {"stem": 0, "ratio": 20}, {"stem": 8, "ratio": 60}],  # 해: 무, 갑, 임
}
...
SHENSHA = {
    ...
    "도화": {
        "type": "중성",
        "description": "매력, 이성 인연이 많음. 예술적 재능, 인기운"
    },
    "화개": {
        "type": "길신",
        "description": "예술, 학문 재능. 종교, 철학적 성향"
    },
    "천을귀인": {
        "type": "길신",
        "description": "귀인의 도움을 받음. 위기시 조력자 출현"
    },
    "문창귀인": {
        "type": "길신",
        "description": "학문, 시험운 좋음. 문서 관련 길함"
    },
    "천덕귀인": {
        "type": "길신",
        "description": "하늘의 덕을 받음. 재난 회피, 복록"
    },
    "월덕귀인": {
        "type": "길신",
        "description": "월의 덕을 받음. 건강, 평안"
    },
    "장성": {
        "type": "길신",
        "description": "리더십, 장군의 별. 명예, 권위"
    },
    "겁살": {
        "type": "흉신",
        "description": "강탈, 도난 주의. 급격한 변화"
    },
    "재살": {
        "type": "흉신",
        "description": "재난, 사고 주의. 안전에 유의"
    },
    "천살": {
        "type": "흉신",
        "description": "하늘의 재앙. 예측 불가한 사건"
    },
    "지살": {
        "type": "흉신",
        "description": "땅의 재앙. 부동산, 이동 관련 주의"
    },
    "년살": {
        "type": "흉신",
        "description": "연의 재앙. 해당 년도 주의"
    },
    "월살": {
        "type": "흉신",
        "description": "월의 재앙. 해당 월 주의"
    },
    "망신살": {
        "type": "흉신",
        "description": "구설, 명예 손상 주의"
    },
    "백호살": {
        "type": "흉신",
        "description": "피, 수술 관련 주의. 사고 주의"
    },
    "양인살": {
        "type": "흉신",
        "description": "날카로움, 칼날. 결단력 있으나 다툼 주의"
    },
    "공망": {
        "type": "중성",
        "description": "공허함, 헛됨. 해당 기운이 약함"
    },
}
