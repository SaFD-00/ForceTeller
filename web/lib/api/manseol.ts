...
export interface City {
  ...
  latitude?: number;
  longitude?: number;
  timezone?: string;      // IANA 시간대 — 해외 출생 시 현지→한국 시각 환산에 필요
}
...
const FALLBACK_CITIES: City[] = [
  { name: 'Seoul', name_ko: '서울', country: 'South Korea', country_ko: '대한민국', latitude: 37.5665, longitude: 126.978, timezone: 'Asia/Seoul' },
  { name: 'Busan', name_ko: '부산', country: 'South Korea', country_ko: '대한민국', latitude: 35.1796, longitude: 129.0756, timezone: 'Asia/Seoul' },
  { name: 'Tokyo', name_ko: '도쿄', country: 'Japan', country_ko: '일본', latitude: 35.6762, longitude: 139.6503, timezone: 'Asia/Tokyo' },
  { name: 'New York City', name_ko: '뉴욕', country: 'United States', country_ko: '미국', latitude: 40.7128, longitude: -74.006, timezone: 'America/New_York' },
  { name: 'London', name_ko: '런던', country: 'United Kingdom', country_ko: '영국', latitude: 51.5074, longitude: -0.1278, timezone: 'Europe/London' },
  { name: 'Paris', name_ko: '파리', country: 'France', country_ko: '프랑스', latitude: 48.8566, longitude: 2.3522, timezone: 'Europe/Paris' },
  { name: 'Beijing', name_ko: '베이징', country: 'China', country_ko: '중국', latitude: 39.9042, longitude: 116.4074, timezone: 'Asia/Shanghai' },
  { name: 'Sydney', name_ko: '시드니', country: 'Australia', country_ko: '호주', latitude: -33.8688, longitude: 151.2093, timezone: 'Australia/Sydney' },
  { name: 'Singapore', name_ko: '싱가포르', country: 'Singapore', country_ko: '싱가포르', latitude: 1.3521, longitude: 103.8198, timezone: 'Asia/Singapore' },
  { name: 'Hong Kong', name_ko: '홍콩', country: 'Hong Kong', country_ko: '홍콩', latitude: 22.3193, longitude: 114.1694, timezone: 'Asia/Hong_Kong' },
];
