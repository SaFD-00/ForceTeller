...
- **2026 tetris 리디자인부터 디스플레이/모노 폰트 추가 vendor**: `Bangers-Regular.woff2`(font-display),
  ...
  family 이름 `Bangers` / `JetBrains Mono` 가 tailwind font-display/font-mono 스택과 매칭. (한글은 Pretendard만)
...
- **2026 tetris-refined 팔레트**: background `#dfe7ff`, foreground/border `#1c202b`, primary `#7107e7`(비비드
  퍼플), accent `#1c398e`, muted `#eef1ff`/`#54608a`, success/warning/danger 추가. 그림자는 하드 오프셋
  솔리드(card `3px 3px 0`, card-hover `5px 5px 0`, block-sm `2px 2px 0`). borderWidth `1.5`/`3` 토큰 추가.
