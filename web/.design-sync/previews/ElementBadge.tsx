...
export function AllElements() {
  return (
    <div style={{ display: "flex", gap: 8, padding: 16, background: "#f7f8fa", flexWrap: "wrap" }}>
...
export function Sizes() {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8, padding: 16, background: "#f7f8fa" }}>
...
export function HanjaOnly() {
  return (
    <div style={{ display: "flex", gap: 8, padding: 16, background: "#f7f8fa" }}>
