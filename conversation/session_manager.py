...
class Session:
    ...
    def add_assistant_message(self, content: str, agent_name: str | None = None) -> Message:
        """어시스턴트 메시지 추가"""
    ...
    def get_cached_interpretation(self, agent_name: str) -> Any | None:
        """캐시된 해석 반환"""
...
class SessionManager:
    ...
    def create_session(
        ...
        session = Session(session_id=session_id, saju_data=saju_data, metadata=metadata or {})
