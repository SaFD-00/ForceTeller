...
class TestOrchestratorDependency:
    ...
    def test_get_orchestrator_with_provider(self):
        """get_orchestrator가 provider를 올바르게 전달하는지 확인"""
        orch = get_orchestrator(llm_provider="gemini")

        assert orch.llm_provider == "gemini"
...
class TestLLMClientDependency:
    ...
    def test_get_llm_client_with_provider(self):
        """get_llm_client가 provider를 올바르게 전달하는지 확인"""
